 ...
 *
 * @author Luan P
 * Preferencia de quem vem do Oeste(SIDERURGICA)
 */


public class TrabalhoSO_Oeste extends Application{
                ...
                try{
                    ...
                    while(acorda.availablePermits()==0){
                        if(origem.equals("oeste")){
                            ...
                            if(!sentido_ponte.equals(origem) && oeste.availablePermits()==numcar && leste.availablePermits()>0 && lista_oeste.size()==0){
                                acorda.release();
                            }
                            else{
                                System.out.println("Carro "+id+" dorme");
    ...
    public void start(Stage stage) {
        ...
        try{
            ...
            stage.setTitle("Trabalho SO - Preferencia de quem vem do Oeste (Siderurgica)");  
