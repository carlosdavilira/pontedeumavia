 ...
 *
 * @author Luan P
 * Preferencia de quem vem do Leste(MINA)
 */


public class TrabalhoSO_Leste extends Application{
                ...
                try{
                    ...
                    while(acorda.availablePermits()==0){
                        if(origem.equals("oeste")){
                            ...
                            if(!sentido_ponte.equals(origem) && leste.availablePermits()==numcar && oeste.availablePermits()>0 && lista_leste.size()==0){
                                acorda.release();
                            }
                            else{
    ...
    public void start(Stage stage) {
        ...
        try{
            ...
            stage.setTitle("Trabalho SO - Preferencia de quem vem do Leste (Mina)");  
